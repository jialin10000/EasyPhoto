...
enum StringKey {
    ...
    var zh: String {
        ...
        case .shortcutHint: return "快捷键：← → 切换图片 | 点击左/右侧切换 | S 幻灯片 | I 信息 | F 全屏 | ⌫ 删除"
        ...
        case .helpShortcutDelete: return "⌫ 或 ⌘⌫ — 把当前图片移到废纸篓（会先询问）"
    ...
    var en: String {
        ...
        case .shortcutHint: return "Shortcuts: ← → switch | Click left/right side | S slideshow | I info | F fullscreen | ⌫ delete"
        ...
        case .helpShortcutDelete: return "⌫ or ⌘⌫ — Move current image to Trash (asks first)"
